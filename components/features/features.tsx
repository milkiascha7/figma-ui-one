...
const Features = () => {
  return (
    <div className="w-full h-full mt-40 flex flex-col gap-y-10 lg:gap-y-8 md:items-center justify-start md:justify-center mx-20 overflow-x-hidden">
      ...
      <div className="flex flex-col w-full h-full relative md:justify-center lg:items-center mt-10 lg:mt-0">
        <div className="w-full h-[253px] purple-gradient absolute" />
